...
export const vocabLabel = document.getElementById("vocab-label");
export const solveVocab = /** @type {HTMLSelectElement} */ (document.getElementById("solve-vocab"));
...
export const sizeFineDown = document.getElementById("size-fine-down");
export const sizeFineUp = document.getElementById("size-fine-up");
